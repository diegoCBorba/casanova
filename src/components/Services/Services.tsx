...
export const ServicesHome = () => {
  return (
    <div className={service.background}>
      <section id="about" className={`container-section ${service.containerSection}`}>
        <div className={service.containerServices}>
          <div className={service.boxAbout}>
            <Title>Serviços</Title>
            <h1>Nossa Tipologia de Serviços</h1>
            <p>Transformamos seu espaço comercial em um ambiente funcional e elegante.</p>
            <Link to="/services" className="btn-flip2" data-back="Serviços" data-front="Saiba mais"/>
          </div>
          <div className={service.containerLinks}>
            <div className={service.boxServices}>
              ...
              <p>Móveis personalizados que otimizam cada canto da sua casa, unindo estética e praticidade para criar o lar dos seus sonhos.</p>
              {/* <svg className={service.animateSvg}>
                <rect x="0" y="0" fill="none" width="100%" height="100%"/>
              </svg> */}
              <Link to="/services/residential" className={service.iconShare}>
            ...
            <div className={service.boxServices}>
              ...
              <p>Soluções sob medida que combinam funcionalidade e design para transformar seu espaço de trabalho em um ambiente inspirador e eficiente.</p>
              {/* <svg className={service.animateSvg}>
                <rect x="0" y="0" fill="none" width="100%" height="100%"/>
              </svg> */}
              <Link to="/services/commercials" className={service.iconShare}>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-external-link"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg>
              </Link>
            </div>
          </div>
